(function(t) {
    ...
    var e = {
            ...
            widgetSection: function(i) {
                function a(t) {
                    ...
                    function a() {
                        ...
                        "sticky" == x ? t(window).scroll(o) : "fixed" == x && (r(), t(window).scroll(o)), "yes" == i.data("wpr-replace-header") && (console.log(i.next()), 0 != i.next().length && i.next().get(0).style.setProperty("--wpr-animation-duration", k));
                        let d
                    }
            ...
            widgetMegaMenu: function(i) {
                ...
                d.find(".wpr-mobile-toggle").on("click", function(a) {
                ...
                if (h.length) {
                    ...
                    if (V.observe(a[0], {
                        ...
                        var H = h.find(".wpr-grid-item-add-to-cart").find("i"),
                            N = H.attr("class");
                        H.length && (N = N.substring(N.indexOf("fa-"), N.length)), t("body").on("adding_to_cart", function(e, t) {
                            t.fadeTo("slow", 0)
                            ...
                            H.length && (s.find("i").removeClass(N).addClass("fa-check"), setTimeout(function() {
                                s.find("i").removeClass("fa-check").addClass(N)
                            }, 3500))
                        })
                    }

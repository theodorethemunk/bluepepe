...
! function(e, t) {
    ...
    var T, z, t, o, S = function(e, t) {
        ...
        i = function(e, o) {
            ...
            if (Array.prototype.map && e.map === Array.prototype.map) r = Array.prototype.map.call(e, function(e) {
                ...
                for (t = 0; t < i; t++) callback_params = n, callback_params.splice(0, 0, e[t]), r.push(o.apply(this, callback_params));
            return r
        },
        s = function(e) {
            var t, o = [];
        ...
        a = function(e, t) {
            var o, n, r, i, s;
            for (o = 0; o < e.length; o++) e[o] instanceof google.maps.LatLng || (0 < e[o].length && "object" == typeof e[o][0] ? e[o] = a(e[o], t) : e[o] = (n = e[o], r = t, s = i = void 0, i = n[0], s = n[1], r && (i = n[1], s = n[0]), new google.maps.LatLng(i, s)));
            return e
        },
        W = function(e, t) {
            e = e.replace("#", "");
        ...
        p = (T = document, z = function(o) {
            ...
            var e, t = function(e, t) {
                ...
                i = ["el", "lat", "lng", "mapType", "width", "height", "markerClusterer", "enableNewStyle"],
                s = o.el || o.div,
                a = o.markerClusterer,
            ...
            for (window.context_menu = window.context_menu || {}, window.context_menu[u.el.id] = {}, this.controls = [], this.overlays = [], this.layers = [], this.singleLayers = {}, this.markers = [], this.polylines = [], this.routes = [], this.polygons = [], this.infoWindow = null, this.overlay_el = null, this.zoom = o.zoom, this.registered_events = {}, this.el.style.width = o.width || this.el.scrollWidth || this.el.offsetWidth, this.el.style.height = o.height || this.el.scrollHeight || this.el.offsetHeight, google.maps.visualRefresh = o.enableNewStyle, e = 0; e < i.length; e++) delete o[i[e]];
            for (1 != o.disableDefaultUI && (L = S(L, b)), k = S(L, o), e = 0; e < n.length; e++) delete k[n[e]];
            for (e = 0; e < r.length; e++) delete k[r[e]];
            this.map = new google.maps.Map(this.el, k), a && (this.markerClusterer = a.apply(this, [this.map]));
            var _ = function(t, o) {
                var e = "",
            ...
            this.buildContextMenu = function(o, n) {
                ...
                o.id = "gmaps_context_menu", o.style.display = "none", o.style.position = "absolute", o.style.minWidth = "100px", o.style.background = "white", o.style.listStyle = "none", o.style.padding = "8px", o.style.boxShadow = "2px 2px 6px #ccc", W("gmaps_context_menu") || T.body.appendChild(o);
    ...
    return p.prototype.createControl = function(o) {
        ...
        for (var t in e.style.cursor = "pointer", !0 !== o.disableDefaultStyles && (e.style.fontFamily = "Roboto, Arial, sans-serif", e.style.fontSize = "11px", e.style.boxShadow = "rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px"), o.style) e.style[t] = o.style[t];
        for (var n in o.id && (e.id = o.id), o.title && (e.title = o.title), o.classes && (e.className = o.classes), o.content && ("string" == typeof o.content ? e.innerHTML = o.content : o.content instanceof HTMLElement && e.appendChild(o.content)), o.position && (e.position = google.maps.ControlPosition[o.position.toUpperCase()]), o.events) ! function(e, t) {
        ...
        var c = ["animation_changed", "clickable_changed", "cursor_changed", "draggable_changed", "flat_changed", "icon_changed", "position_changed", "shadow_changed", "shape_changed", "title_changed", "visible_changed", "zindex_changed"],
            g = ["dblclick", "drag", "dragend", "dragstart", "mousedown", "mouseout", "mouseover", "mouseup"];
        ...
        return google.maps.event.addListener(a, "click", function() {
            this.details = e, n.click && n.click.apply(this, [this]), a.infoWindow && (t.hideInfoWindows(), a.infoWindow.open(t.map, a))
        ...
        if (void 0 === e) {
            ...
            for (o = 0; o < e.length; o++) {
                ...
                if (-1 < n)(r = this.markers[n]).setMap(null), this.markerClusterer && this.markerClusterer.removeMarker(r), p.fire("marker_removed", r, this)
            }
        ...
        return a.setMap(this.map), null != s.auto_show && (i = s.auto_show), a.onAdd = function() {
            var e = document.createElement("div");
            e.style.borderStyle = "none", e.style.borderWidth = "0px", e.style.position = "absolute", e.style.zIndex = 100, e.innerHTML = s.content, a.el = e, s.layer || (s.layer = "overlayLayer");
            var t, o, n = this.getPanes(),
        ...
        if (t.length)
            if (void 0 === t[0][0]) e = t;
                ...
                for (var n, r = 0; n = t[r]; r++) e.push(new google.maps.LatLng(n[0], n[1]));
        var i = {
            map: this.map,
            path: e,
        ...
        o.hasOwnProperty("clickable") && (i.clickable = o.clickable), o.hasOwnProperty("editable") && (i.editable = o.editable), o.hasOwnProperty("icons") && (i.icons = o.icons), o.hasOwnProperty("zIndex") && (i.zIndex = o.zIndex);
        ...
        e.origin = /string/.test(typeof n.origin) ? n.origin : new google.maps.LatLng(n.origin[0], n.origin[1]), e.destination = /string/.test(typeof n.destination) ? n.destination : new google.maps.LatLng(n.destination[0], n.destination[1]), e.travelMode = t, e.unitSystem = o, delete e.callback, delete e.error;
        var r = [];
        ...
        if (i.origin && i.destination) this.getRoutes({
            ...
            callback: function(e) {
                if (0 < e.length && i.start && i.start(e[e.length - 1]), 0 < e.length && i.step) {
                    var t = e[e.length - 1];
                    if (0 < t.legs.length)
                        for (var o, n = t.legs[0].steps, r = 0; o = n[r]; r++) o.step_number = r, i.step(o, t.legs[0].steps.length - 1)
                }
                0 < e.length && i.end && i.end(e[e.length - 1])
            }
        });
        else if (i.route && 0 < i.route.legs.length)
            for (var e, t = i.route.legs[0].steps, o = 0; e = t[o]; o++) e.step_number = o, i.step(e)
        ...
        o.position = new google.maps.LatLng(o.lat, o.lng), delete o.el, delete o.context, delete o.lat, delete o.lng;
        ...
        var o = e.callback;
        e.hasOwnProperty("lat") && e.hasOwnProperty("lng") && (e.latLng = new google.maps.LatLng(e.lat, e.lng)), delete e.lat, delete e.lng, delete e.callback, this.geocoder.geocode(e, function(e, t) {
            o(e, t)
        })
        ...
        if (0 === o) return -1;
        var n = 0;
        if (1 < arguments.length && ((n = Number(arguments[1])) != n ? n = 0 : 0 != n && n != 1 / 0 && n != -1 / 0 && (n = (0 < n || -1) * Math.floor(Math.abs(n)))), o <= n) return -1;
